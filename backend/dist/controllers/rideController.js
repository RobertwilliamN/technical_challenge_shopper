...
exports.getRidesByCustomer = exports.confirmRide = exports.estimateRide = void 0;
...
const estimateRide = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const route = yield (0, googleMapsService_1.getRoute)(origin, destination);
        ...
        const options = drivers_1.drivers.filter((driver) => distance >= driver.minKm)
            .map((driver) => ({
            id: driver.id,
            name: driver.name,
...
const confirmRide = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const selectedDriver = drivers_1.drivers.find((d) => d.id === driver.id && d.name === driver.name);
        if (!selectedDriver) {
            res.status(404).json({
        ...
        // **Salvar no banco de dados**
        const rideSaved = yield (0, rideService_1.saveRideToDatabase)({
            customer_id,
...
const getRidesByCustomer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (driver_id) {
            ...
            const driverExists = drivers_1.drivers.find(driver => driver.id === parseInt(driverIdStrFinal));
            if (!driverExists) {
                res.status(400).json({
        ...
        const rides = yield db.all(query, params);
        ...
        res.status(200).json({
            ...
            rides: rides.map((ride) => {
                ...
                return ({
                    ...
                    driver: {
                        id: ride.driver_id,
                        name: ((_a = drivers_1.drivers.find(driver => driver.id === ride.driver_id)) === null || _a === void 0 ? void 0 : _a.name) || "Unknown Driver", // Nome do motorista
                    },
                    value: ride.value,
                });
            }),
